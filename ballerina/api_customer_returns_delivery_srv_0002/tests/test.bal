...
import sap.s4hana.api_customer_returns_delivery_srv_0002.mock as _;
...
function testListA_ReturnsDeliveryItem() returns error? {
    CollectionOfA_ReturnsDeliveryItemWrapper returnsDeliveryItem = check s4HanaClient->listA_ReturnsDeliveryItems();
    test:assertTrue(returnsDeliveryItem.d?.results !is (), "The  is expected to be non-empty.");
}
